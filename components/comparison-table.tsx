...
export default function ComparisonTable() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-8 sm:py-12">
      <div className="bg-card rounded-2xl p-5 sm:p-8 shadow-lg">
        {/* Header */}
        <div className="hidden sm:grid grid-cols-3 items-center bg-muted rounded-xl mb-6 py-6 px-6">
          <div className="text-foreground font-semibold text-lg text-left">
            Features
          </div>
          ...
          <div className="text-foreground font-semibold text-lg text-right">
            Other Platforms
          </div>
        </div>
        ...
        <div className="space-y-4">
          {displayedData.map((item, index) => (
            <div
              key={index}
              className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 border border-border rounded-xl bg-background"
            >
